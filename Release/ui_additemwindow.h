...
public:
    ...
    void setupUi(QDialog *AddItemWindow)
    {
        ...
        AddItemWindow->resize(536, 417);
        verticalLayout_12 = new QVBoxLayout(AddItemWindow);
        ...
        label = new QLabel(AddItemWindow);
        label->setObjectName("label");

        verticalLayout_2->addWidget(label);

        nameField = new QLineEdit(AddItemWindow);
        ...
        label_2 = new QLabel(AddItemWindow);
        label_2->setObjectName("label_2");

        verticalLayout_3->addWidget(label_2);

        descriptionField = new QPlainTextEdit(AddItemWindow);
        ...
        picDisplay = new QLabel(AddItemWindow);
        ...
        picButton = new QPushButton(AddItemWindow);
        ...
        label_3 = new QLabel(AddItemWindow);
        label_3->setObjectName("label_3");

        verticalLayout_5->addWidget(label_3);

        statNameComboBox = new QComboBox(AddItemWindow);
        ...
        label_4 = new QLabel(AddItemWindow);
        label_4->setObjectName("label_4");

        verticalLayout_8->addWidget(label_4);

        minField = new QSpinBox(AddItemWindow);
        ...
        label_5 = new QLabel(AddItemWindow);
        label_5->setObjectName("label_5");

        verticalLayout_7->addWidget(label_5);

        valueField = new QSpinBox(AddItemWindow);
        ...
        label_6 = new QLabel(AddItemWindow);
        label_6->setObjectName("label_6");

        verticalLayout_6->addWidget(label_6);

        maxField = new QSpinBox(AddItemWindow);
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, AddItemWindow, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, AddItemWindow, qOverload<>(&QDialog::reject));
    ...
    {
        AddItemWindow->setWindowTitle(QCoreApplication::translate("AddItemWindow", "Dialog", nullptr));
        label->setText(QCoreApplication::translate("AddItemWindow", "Nom", nullptr));
        label_2->setText(QCoreApplication::translate("AddItemWindow", "Description", nullptr));
        picDisplay->setText(QString());
        picButton->setText(QCoreApplication::translate("AddItemWindow", "Ajouter une image...", nullptr));
        label_3->setText(QCoreApplication::translate("AddItemWindow", "Statistiques", nullptr));
        label_4->setText(QCoreApplication::translate("AddItemWindow", "Min", nullptr));
        label_5->setText(QCoreApplication::translate("AddItemWindow", "Value", nullptr));
        label_6->setText(QCoreApplication::translate("AddItemWindow", "Max", nullptr));
        addButton->setText(QCoreApplication::translate("AddItemWindow", "Ajouter", nullptr));
    } // retranslateUi
